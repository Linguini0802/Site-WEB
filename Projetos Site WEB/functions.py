...
caminho = r"C:\Users\Vini\OneDrive\Desktop\Programação\Projetos Site WEB\cadastros.json"
...
def cadastrar_usuarios(usuario, senha):
    '''cadastrar_usuarios: Ao chamar a função, ele vai inserir o usuário e a senha informada no cadastros.json'''